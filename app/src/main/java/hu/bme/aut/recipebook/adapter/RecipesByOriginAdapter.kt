...
class RecipesByOriginAdapter(private val context: Context) : RecyclerView.Adapter<RecipesByOriginAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(viewHolder: ViewHolder, position: Int) {
        ...
        if(tmpItem.origin.equals(origin2)) {
                        ...
                        override fun onDataChange(datasnapshot: DataSnapshot) {
                            ...
                            for (ds in datasnapshot.children) {
                                ...
                                if (ds.key.toString().equals(tmpItem.name)) {
                                    ...
                                    val ingredientList =
                                        ingredients.toString().split(",").toTypedArray()
                            ...
                            intent.putExtra("originBy", origin2)
    ...
    fun addPost(rlist: Recipe?, origin: String) {
